    ...
    <?php foreach ($data as $dt);?>
    	...
    	<h1
            style="text-align: center;
                   font-weight:bold; 
                   text-transform: uppercase;">Edit Data Kasir</h1>

        <p></p>
		<div data-demo-html="#panel-responsive-page1" style="justify-content: center;">
        <form class="userform" method="post" action="<?php echo base_url('index.php/C_kasir/Update')?>">
            ...
            <label for="name">Telp Kasir:</label>
            <input type="text" name="telp" id="telp" value="<?php echo $dt->telp;?>">
            <label for="name">Alamat Kasir:</label>
            <input type="text" name="alamat" id="alamat" value="<?php echo $dt->alamat;?>">

            <div class="ui-grid-a" style="justify-content: center;">
                <div class="ui-block-a"><a href="<?php echo base_url('index.php/C_kasir/lihat');?>" data-rel="close" class="ui-btn ui-shadow ui-corner-all ui-btn-b ui-mini">Lihat</a></div><br> 
                <div class="ui-block-a"><a href="<?php echo base_url('index.php/C_kasir/Hapus/').$dt->id;?>" data-rel="close" class="ui-btn ui-shadow ui-corner-all ui-btn-b ui-mini">Hapus</a></div><br>
