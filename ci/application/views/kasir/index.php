...
<body style="background-color: #3498db;">
    <div data-role="page" class="jqm-demos ui-responsive-panel" id="panel-responsive-page1" data-title="Panel responsive page">
        ...
        <div role="main" class="ui-content jqm-content jqm-fullwidth">
            ...
            <h1 style="text-align: center; font-weight:bold; text-transform: uppercase;">Input Data Kasir</h1>

            <p></p>
            <div data-demo-html="#panel-responsive-page1" style="justify-content: center;">
                <form class="userform" method="post" action="<?php echo base_url('index.php/C_kasir/Insert');?>">

                    <label for="nama">Nama Kasir:</label>
                    <input type="text" name="nama" id="nama" value="" data-clear-btn="true" data-mini="true" required>
                    <label for="telp">Telp Kasir:</label>
